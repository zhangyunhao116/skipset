...
func (n *int32node) storeNext(i int, next *int32node) {
...
func (n *int32node) atomicStoreNext(i int, next *int32node) {
...
// If f returns false, range stops the iteration.
func (s *Int32Set) RangeFrom(start int32, f func(value int32) bool) {
	var (
		x   = s.header
		nex *int32node
	)
