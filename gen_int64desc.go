...
func (n *int64nodeDesc) storeNext(i int, next *int64nodeDesc) {
...
func (n *int64nodeDesc) atomicStoreNext(i int, next *int64nodeDesc) {
...
// If f returns false, range stops the iteration.
func (s *Int64SetDesc) RangeFrom(start int64, f func(value int64) bool) {
	var (
		x   = s.header
		nex *int64nodeDesc
	)
