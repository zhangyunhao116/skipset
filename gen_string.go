...
func (n *stringnode) storeNext(i int, next *stringnode) {
...
func (n *stringnode) atomicStoreNext(i int, next *stringnode) {
...
// If f returns false, range stops the iteration.
func (s *StringSet) RangeFrom(start string, f func(value string) bool) {
	var (
		x   = s.header
		nex *stringnode
	)
