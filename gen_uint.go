...
func (n *uintnode) storeNext(i int, next *uintnode) {
...
func (n *uintnode) atomicStoreNext(i int, next *uintnode) {
...
// If f returns false, range stops the iteration.
func (s *UintSet) RangeFrom(start uint, f func(value uint) bool) {
	var (
		x   = s.header
		nex *uintnode
	)
