...
func (n *uint32node) storeNext(i int, next *uint32node) {
...
func (n *uint32node) atomicStoreNext(i int, next *uint32node) {
...
// If f returns false, range stops the iteration.
func (s *Uint32Set) RangeFrom(start uint32, f func(value uint32) bool) {
	var (
		x   = s.header
		nex *uint32node
	)
