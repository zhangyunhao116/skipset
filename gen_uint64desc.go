...
func (n *uint64nodeDesc) storeNext(i int, next *uint64nodeDesc) {
...
func (n *uint64nodeDesc) atomicStoreNext(i int, next *uint64nodeDesc) {
...
// If f returns false, range stops the iteration.
func (s *Uint64SetDesc) RangeFrom(start uint64, f func(value uint64) bool) {
	var (
		x   = s.header
		nex *uint64nodeDesc
	)
