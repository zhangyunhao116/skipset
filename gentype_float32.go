...
// Float32Set represents a set based on skip list.
...
func (n *float32node) storeNext(i int, next *float32node) {
...
func (n *float32node) atomicStoreNext(i int, next *float32node) {
